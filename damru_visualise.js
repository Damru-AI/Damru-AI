...
(function () {
  ...
  window.DamruVisualise = { open: open, close: close, generate: generate, getSTLBlob: getSTLBlob, cancel: cancelGeneration, state: S, setSelectedMaterial:applySelectedMaterial, category:universalCategory, dnaSpec:dnaSpec, moleculeSpec:moleculeSpec, proteinSpec:proteinSpec };
